...
DBPATH     = u"\database\\NeitherNorIncaDb"        # path and name of used database
TOPFOLDER  = u"O2Simulator"                        # name of top folder
SUBFOLDER  = u""                                   # name of sub folder
EXPERIMENT = u"SimulExp"                           # name of experiment element
WORKSPACE  = u"O2Simulator"                        # name of workspace element
...
# )
    ...
    def GetMeasureChar(self,Name):
        oME_MeasureName = self.oExp.GetMeasureElement(Name)
        oCV_MeasureName = oME_MeasureName.GetValue()
        Ret = oCV_MeasureName.GetCharPhysValue()  # 返回MAP或则 值
        return Ret
